...
import { CopyIcon, RefreshCwIcon, LogOutIcon } from 'lucide-react'
...
function AppPage() {
  ...
  return (
    <main className="mx-auto flex min-h-svh w-full max-w-4xl flex-col p-4 sm:p-6">
      ...
      <div className="flex flex-1 flex-col gap-4 py-4">
        ...
        {!secondMember ? (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Comparte el código o el enlace. Solo uno de los dos se mostrará
                en pantalla; podrás generar uno nuevo cuando quieras.
              </CardDescription>
            </CardHeader>
        ...
        <Card className="bg-muted/40">
          <CardContent className="text-center text-sm text-muted-foreground">
            Próximamente: el catálogo compartido para elegir qué ver.
          </CardContent>
        </Card>
      </div>
    </main>
